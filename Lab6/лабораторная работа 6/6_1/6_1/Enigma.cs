...
namespace ConsoleApp1
{
    public class Enigma
    {
        ...
        private static readonly string _betaRotor = "ESOVPZJAYQUIRHXLNFTGKDCMWB";
        private static readonly string[] _reflectorBDunn = { "AY", "BR", "CU", "DH", "EQ", "FS", "GL", "IP", "JX", "KN", "MO", "TZ", "VW" };
